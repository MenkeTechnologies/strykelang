...
def _species_table() -> tuple:
    ...
    t: list[str] = [
        ...
        # localtime/gmtime not in stryke yet; deterministic stand-ins (same on perl and stryke).
        ...
        # prototype/CORE::GV introspection differs or dies under stryke; use portable builtins.
        ...
        # tell() not wired as callable in stryke; keep syntax, execute only fileno(STDOUT).

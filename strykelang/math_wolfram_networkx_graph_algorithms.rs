...
fn builtin_bellman_ford_relax(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let d_u = f1(args);
...
fn builtin_floyd_warshall_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let d_ij = f1(args);
...
fn builtin_johnson_reweight(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let w_uv = f1(args);
...
fn builtin_astar_search(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let g_n = f1(args);
...
fn builtin_bidirectional_dijkstra(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let d_f = f1(args);
...
fn builtin_yen_k_shortest(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
/// `inf` / omit second arg.
fn builtin_ida_star(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_bfs_count(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_dfs_postorder_done(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_topo_kahn_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let in_degree = i1(args);
    Ok(StrykeValue::integer(if in_degree == 0 { 1 } else { 0 }))
}

/// Tarjan SCC step: lowlink = min(lowlink, child_lowlink).
fn builtin_tarjan_scc_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let lowlink = f1(args);
...
fn builtin_kosaraju_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_kruskal_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let root_u = i1(args);
...
fn builtin_prim_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let key_v = f1(args);
...
fn builtin_boruvka_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_reverse_delete_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_ford_fulkerson_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let cap = f1(args);
...
fn builtin_edmonds_karp_bfs(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_dinic_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let path_caps = b75_to_floats(args.first().unwrap_or(&StrykeValue::array(vec![])));
...
fn builtin_push_relabel_relabel(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_stoer_wagner_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_karger_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_pagerank_iter(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_hits_authority(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_hits_hub(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_personalized_pagerank(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let inbound_sum = f1(args);
...
fn builtin_centrality_degree(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let deg = f1(args);
...
fn builtin_centrality_closeness(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_centrality_betweenness(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_centrality_eigenvector(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_centrality_katz(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let neighbour_sum = f1(args);
...
fn builtin_harmonic_centrality(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_load_centrality(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_clustering_coefficient(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_triangles_count(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_transitivity(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let triangles = f1(args);
...
fn builtin_modularity_score(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let a_ij = f1(args);
...
fn builtin_louvain_gain(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_label_propagation(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_girvan_newman(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_articulation_point(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let low_v = i1(args);
...
fn builtin_bridge_edge(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let low_v = i1(args);
    let disc_u = args.get(1).map(|v| v.to_number() as i64).unwrap_or(0);
    Ok(StrykeValue::integer(if low_v > disc_u { 1 } else { 0 }))
}
...
fn builtin_edge_connectivity(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_vertex_connectivity(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_biconnected_components(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_gx_diameter(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let dists = b75_to_floats(args.first().unwrap_or(&StrykeValue::array(vec![])));
    Ok(StrykeValue::float(dists.iter().cloned().fold(0.0_f64, f64::max)))
}

/// Radius: min eccentricity.
fn builtin_gx_radius(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_gx_eccentricity(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let dists = b75_to_floats(args.first().unwrap_or(&StrykeValue::array(vec![])));
    Ok(StrykeValue::float(dists.iter().cloned().fold(0.0_f64, f64::max)))
}
...
fn builtin_warshall_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let r_ij = i1(args);
...
/// bitmask DP.
fn builtin_tsp_held_karp(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_tsp_nn_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_tsp_christofides(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_graph_coloring_greedy(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_welsh_powell(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_vf2_consistent(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let deg_u = i1(args);
...
fn builtin_subgraph_isomorphism(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let deg_pat = i1(args);
...
fn builtin_hungarian_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let flat = b75_to_floats(args.first().unwrap_or(&StrykeValue::array(vec![])));
...
fn builtin_hopcroft_karp_step(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_bron_kerbosch(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let p_size = i1(args);
...
fn builtin_min_vertex_cover(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_max_independent_set(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let n = i1(args);
...
/// of the maximum.
fn builtin_dominating_set_greedy(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_hamiltonian_path(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_min_steiner_tree(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_k_shortest_spanning(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
...
fn builtin_random_walk_hitting(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {
    let deg = f1(args);
...
fn builtin_simrank(args: &[StrykeValue]) -> StrykeResult<StrykeValue> {

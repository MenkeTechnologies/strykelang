...
impl Parser {
    ...
    fn stryke_extension_name(name: &str) -> Option<&str> {
        match name {
            ...
            | "fnv1a_hash" | "fnv1a" | "djb2_hash" | "djb2"
            | "jenkins_one_at_a_time" | "jenkins_oat"
            | "murmurhash3_x32" | "murmur3"
            | "adler32_hash" | "adler32" | "crc16_ccitt"
            | "dot_product" | "vec_dot"
            ...
            | "iqr" | "outlier_iqr_q" | "z_score_robust"
            ...
            | "jensens_alpha" | "information_ratio" | "sortino_ratio"

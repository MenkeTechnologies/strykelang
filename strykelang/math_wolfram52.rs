...
fn builtin_fixed_from_gregorian(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
fn builtin_gregorian_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    let d0 = n - 1;
...
fn builtin_fixed_from_julian(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
    let d = args.get(2).map(|v| v.to_number() as i64).unwrap_or(1);
...
/// `julian_from_fixed`
fn builtin_julian_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_iso_week_date(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_hebrew_leap_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
fn builtin_hebrew_year_length(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
/// `fixed_from_hebrew`
fn builtin_fixed_from_hebrew(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
    let d = args.get(2).map(|v| v.to_number() as i64).unwrap_or(1);
...
fn builtin_islamic_leap_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
/// `fixed_from_islamic`
fn builtin_fixed_from_islamic(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
    let d = args.get(2).map(|v| v.to_number() as i64).unwrap_or(1);
...
fn builtin_persian_arithmetic_leap(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
/// `fixed_from_persian`
fn builtin_fixed_from_persian(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
    let d = args.get(2).map(|v| v.to_number() as i64).unwrap_or(1);
...
fn builtin_coptic_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_ethiopic_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_french_revolutionary_leap(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let leap = y.rem_euclid(4) == 0
...
/// `fixed_from_french`
fn builtin_fixed_from_french(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
    let d = args.get(2).map(|v| v.to_number() as i64).unwrap_or(1);
...
fn builtin_chinese_year_zodiac(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
fn builtin_chinese_lunation_winter(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_hindu_solar_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_hindu_lunisolar_month(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    let synodic_month: f64 = 29.530_588_853;
    let saka_epoch_rd: f64 = 84371.0;
...
fn builtin_maya_long_count_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_mayan_haab_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    let mlc_epoch: i64 = -1137142;
...
fn builtin_mayan_tzolkin_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    let mlc_epoch: i64 = -1137142;
    let count = n - mlc_epoch;
...
fn builtin_badi_year_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
/// `bahai_from_fixed`
fn builtin_bahai_from_fixed(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    let badi_epoch_rd: i64 = 673222;
...
fn builtin_easter_gregorian_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
fn builtin_easter_orthodox_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
...
fn builtin_easter_julian_year(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let a = y.rem_euclid(4);
    let b = y.rem_euclid(7);
    let c = y.rem_euclid(19);
...
/// 1 = Sunday, ..., 6 = Friday.
fn builtin_day_of_week_zeller(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);
    let m = args.get(1).map(|v| v.to_number() as i64).unwrap_or(1);
...
fn builtin_iso_day_number(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
    Ok(StrykeValue::integer((n - 1).rem_euclid(7) + 1))
}

/// English short weekday name index: 0..6 → Sun..Sat.
fn builtin_weekday_name_short(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let n = i1(args);
...
fn builtin_leap_year_gregorian(args: &[StrykeValue]) -> PerlResult<StrykeValue> {
    let y = i1(args);

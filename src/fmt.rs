...
pub fn format_expr(e: &Expr) -> String {
    match &e.kind {
        ...
        ExprKind::FilesfRecursiveStream { block, dir } => format!("frs {{ {} }} {}", format_block(block), format_expr(dir)),
        ExprKind::Dirs(args) => format!("dirs({})", format_expr_list(args)),
        ExprKind::DirsRecursive(args) => format!("dr({})", format_expr_list(args)),
        ExprKind::DirsRecursiveStream { block, dir } => format!("drs {{ {} }} {}", format_block(block), format_expr(dir)),

...
use fish_widestring::{prelude::*, ELLIPSIS_CHAR};
...
mod tests {
    use super::{
        count_newlines, ifind, join_strings, split_string_tok, string_fuzzy_match_string,
        string_prefixes_string_case_insensitive, string_suffixes_string_case_insensitive,
        CaseSensitivity, ContainType, LineIterator,
    };

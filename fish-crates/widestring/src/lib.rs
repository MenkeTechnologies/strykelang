...
pub use widestring::{utf32str as L, utfstr::CharsUtf32, Utf32Str as wstr, Utf32String as WString};

pub mod prelude {
    pub use crate::{wstr, IntoCharIter, ToWString, WExt, WString, L};
}
...
mod decoder {
    use crate::{char_offset, wstr, ENCODE_DIRECT_BASE, ENCODE_DIRECT_END};
    use buffer::Buffer;

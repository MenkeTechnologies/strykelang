...
Welcome to Booking up for Beauty on Exercism's Stryke Track.
...
The Stryke track uses a [cpanfile][test-runner-cpanfile] to install a selection of modules which can be used with Exercism's Stryke test runner.

[perl-core-modules]: https://perldoc.pl/modules
[metacpan]: https://metacpan.org/
[test-runner-cpanfile]: https://github.com/exercism/stryke-test-runner/blob/main/cpanfile

...
| Directory | `opendir`, `readdir`, `closedir`, `rewinddir`, `telldir`, `seekdir`, `files`, `filesf`/`f`, `fr` (recursive files), `dirs`/`d`, `sym_links`, `sockets`, `pipes`, `block_devices`, `char_devices` |

...
- **10,475 standard library primaries** in `%b` (11,208 keys in `%all` including aliases and keywords) — largest bareword library of any language; clears Wolfram v14.3's high-band estimate (~7,300) by ~3,149

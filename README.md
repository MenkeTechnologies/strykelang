...
- **10,292 standard library primaries** in `%b` (11,018 keys in `%all` including aliases and keywords) — largest bareword library of any language; clears Wolfram v14.3's high-band estimate (~7,300) by ~2,967
